class Alumnos{
    ...
    obsequio = () => {
        let promedio = this.promedio();
        if(promedio > 17)
            return `Felicidades, ganaste una mochila!!!`;
        else
            return `Esfuerzate un poco más, tú puedes!!!`;
    }
}

const btnCalcular = document.getElementById("btnCalcular");
btnCalcular.addEventListener("click", alumnos);
...
function alumnos(){
    ...
    let alumno1 = new Alumnos(codigo,nombre,{"nota1":nota1,"nota2":nota2,"nota3":nota3,"nota4":nota4})
